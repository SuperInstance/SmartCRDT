 ...
 */
export const CARTRIDGE_MANIFEST_SCHEMA = {
  $schema: "http://json-schema.org/draft-07/schema#",
  $id: "https://lsi.dev/schemas/cartridge-manifest.json",
  title: "Cartridge Manifest",
  description:
    "Metadata and capabilities for a knowledge cartridge in the Aequor Cognitive Orchestration Platform",
  type: "object",
  required: [
    "id",
    "version",
  ...
  properties: {
    ...
    description: {
      ...
      maxLength: 1000,
      description:
        "Detailed description of the cartridge's purpose and contents",
    },
    author: {
      type: "string",
      minLength: 1,
