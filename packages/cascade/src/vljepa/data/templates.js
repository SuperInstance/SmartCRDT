...
export const QUERY_TEMPLATES = [
    ...
    {
        template: "What is the complexity of {algorithm} and how can I optimize it?",
        intent: IntentCategory.QUERY,
        slots: {
            algorithm: [
                "binary search",
...
export const CONVERSATION_TEMPLATES = [
    ...
    {
        template: "I'm not sure I understand {concept}. Can you explain differently?",
        intent: IntentCategory.CONVERSATION,
        slots: {
            concept: [
                "distributed transactions",
...
// ============================================================================
export const DEBUGGING_TEMPLATES = [
    {
...
export const LEARNING_TEMPLATES = [
    ...
    {
        template: "What's the difference between {A} and {B}? Explain for beginners.",
        intent: IntentCategory.ANALYSIS,
        slots: {
