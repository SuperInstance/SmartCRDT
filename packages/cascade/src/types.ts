...
import type {
  RouterConfig as ProtocolRouterConfig,
  CacheConfig,
 ...
 */
export interface RouterConfig extends ProtocolRouterConfig {
  ...
  /** Enable health checks for Ollama */
  enableHealthChecks?: boolean;
  /** Ollama base URL for health checks */
  ollamaBaseURL?: string;
  /** Default Ollama model for health checks */
  ollamaModel?: string;
  ...
  routeFallbackStrategies?: Partial<
    Record<"local" | "cloud" | "hybrid", FallbackStrategy>
  >;
  /** Enable adaptive fallback */
